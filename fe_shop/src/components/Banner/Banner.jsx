...
import Image1 from "../../assets/banner/headphone.png";
...
const Banner = ({ handleOrderPopup }) => {
  ...
  return (
    <div className="container">
      <div className="overflow-hidden rounded-3xl min-h-[550px] sm:min-h-[650px] banner-bg-color flex justify-center items-center">
